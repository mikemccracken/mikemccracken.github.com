...
BLOG_AUTHOR = "Michael McCracken"
BLOG_TITLE = "michael-mccracken.net"
SITE_URL = "http://michael-mccracken.net/"
BLOG_EMAIL = "michael.mccracken@gmail.com"
BLOG_DESCRIPTION = "This is a weblog."
...
LOGO_URL = 'http://michael-mccracken.net/mike_bw_smaller.png'
...
DEPLOY_COMMANDS = {
     'default': ['cp CNAME output/', 'nikola github_deploy']
 }

# For user.github.io/organization.github.io pages, the DEPLOY branch
# MUST be 'master', and 'gh-pages' for other repositories.
GITHUB_SOURCE_BRANCH = 'nikola-source'
...
# is in the manual.
COMMENT_SYSTEM_ID = "michaelmccrackennet"
